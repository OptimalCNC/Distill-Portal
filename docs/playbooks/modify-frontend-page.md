...
1. Start in `apps/frontend/src/App.tsx` (or the relevant feature module under `apps/frontend/src/features/sessions/` for the unified session list, or shared component under `apps/frontend/src/components/`) to change page layout, forms, or rendering.
